...
- [Renovate](#renovate)
  ...
  - [⚠️ What About Breaking Changes?](#️-what-about-breaking-changes)
  ...
  - [Concept of private packages](#concept-of-private-packages)
    ...
    - [Failure mode #1 (MOST COMMON): missing source repository metadata](#failure-mode-1-most-common-missing-source-repository-metadata)
      - [What Renovate expects](#what-renovate-expects)
      - [What often happens with private packages](#what-often-happens-with-private-packages)
  ...
  - [Renovate Presets](#renovate-presets)
    ...
    - [Basic Concept](#basic-concept)
      - [Without presets (manual config):](#without-presets-manual-config)
      - [With presets (clean \& simple):](#with-presets-clean--simple)
